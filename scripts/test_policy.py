...
def run_policy(env, get_action, max_ep_len=None, num_episodes=100, render=True):
    ...
    while n < num_episodes:
        ...
        o, r, d, info = env.step(a)  # swb:这里面的cost，是 {0,1} 这样的indicator啊！！
        ep_ret += r
...
if __name__ == '__main__':
    ...
    args.fpath = '../data/2022-03-24_ppo_lagrangian_PointGoal1/2022-03-24_04-35-08-ppo_lagrangian_PointGoal1_s0'
