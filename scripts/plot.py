...
def plot_data(data, xaxis='Epoch', value="AverageEpRet", 
    ...
    if isinstance(data, list):
        ...
        data = [x for x in data if value in x.columns]  # swb:只把存在value这一项数据的data对象保存下来啊!!
 ...
 (0.09019607843137255, 0.7450980392156863, 0.8117647058823529)]
    ...
    #"""  # swb: seaborn的condition是在搞什么啊？我没看懂啊！！
...
def main():
    ...
    parser.add_argument('--value', '-y', default='StopIter', nargs='*')  # swb:这边可以选择画什么啊。。有很多可以选择啊。。
    # swb：AverageEpCost, StdEpCost, MaxEpCost	MinEpCost, EpLen, CumulativeCost, CostRate, AverageVVals, StdVVals, MaxVVals
    # swb: MinVVals, AverageCostVVals, StdCostVVals, MaxCostVVals, MinCostVVals, LossPi, DeltaLossPi, SurrCost, DeltaSurrCost
    # swb: LossV, DeltaLossV, LossVC, DeltaLossVC, Penalty, DeltaPenalty, StopIter, Entropy, KL, TotalEnvInteracts, Time
    # swb: Performance
    ...
    """
    args.logdir = ['../data/2022-03-24_ppo_lagrangian_PointGoal1/2022-03-24_04-35-08-ppo_lagrangian_PointGoal1_s0']
